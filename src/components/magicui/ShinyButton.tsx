...
const ShinyButton = ({ text = "", img, onClick }: ShinyButtonProps) => {
  return (
    ...
    >
      <span
        className="relative h-full w-full min-w-6 text-sm uppercase tracking-wide text-[rgb(0,0,0,65%)] dark:text-[rgb(255,255,255,90%)] flex items-center justify-center"
        style={{
          maskImage:
